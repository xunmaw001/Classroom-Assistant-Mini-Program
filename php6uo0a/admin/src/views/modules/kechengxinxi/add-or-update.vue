              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengneirong" label="课程内容" prop="kechengneirong">
                    <span>{{ruleForm.kechengneirong}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课程任务" prop="kechengrenwu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="课程任务"
                  v-model="ruleForm.kechengrenwu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechengrenwu" label="课程任务" prop="kechengrenwu">
                    <span>{{ruleForm.kechengrenwu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
