          ...
          <el-form-item class="input" v-if="ruleForm.qiandaoshijian" label="签到时间" prop="qiandaoshijian">
              <el-input v-model="ruleForm.qiandaoshijian" 
                placeholder="签到时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到地点" prop="qiandaodidian">
          <el-input v-model="ruleForm.qiandaodidian" 
              placeholder="签到地点" clearable  :readonly="ro.qiandaodidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到地点" prop="qiandaodidian">
              <el-input v-model="ruleForm.qiandaodidian" 
                placeholder="签到地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../php6uo0a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
