          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="请假理由" prop="qingjialiyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="请假理由"
                  v-model="ruleForm.qingjialiyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qingjialiyou" label="请假理由" prop="qingjialiyou">
                    <span>{{ruleForm.qingjialiyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjiatianshu = true;
            continue;
	            	            ...
	            	            if(o=='qingjialiyou'){
            this.ruleForm.qingjialiyou = obj[o];
	    this.ro.qingjialiyou = true;
            continue;
          }
	            	            if(o=='beizhu'){
