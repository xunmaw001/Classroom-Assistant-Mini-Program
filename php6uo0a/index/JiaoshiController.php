...
class JiaoshiController extends CommonController {
    ...
    public function login(){
        ...
        $password = isset($_REQUEST['password'])?$_REQUEST['password']:"";
                        $sql = "select * from `jiaoshi` where `jiaoshigonghao` = '".$username."' and `mima` = '".$password."'";
    ...
    public function register(){
        ...
        $postData = json_decode($tmpData,true);
                        $colum = "jiaoshigonghao";
        $trues = "select * from `jiaoshi` where `jiaoshigonghao` = '".$postData[$colum]."'";
    ...
    public function resetPass(){
        $username = input('post.username');
                        $counts = "select * from `jiaoshi` where jiaoshigonghao = '".$username."'";
        $cotte = table_sql($counts);
        if($cotte->num_rows<1){
            exit(json_encode(['code'=>500,'msg'=>"用户名错误。"]));
        }
        $sql = "update jiaoshi set mima = '123456' where jiaoshigonghao = '".$username."'";
                                                                                                                                                        		        $result = table_sql($sql);
